...
from policies import allox, finish_time_fairness, gandiva, hierarchical, isolated, \
    max_min_fairness, max_min_fairness_multi_entity, max_sum_throughput
...
class TestPolicies(unittest.TestCase):
    ...
    def test_max_min_fairness_multi_entity_with_perf(self):
        policy = max_min_fairness_multi_entity.MaxMinFairnessMultiEntityPolicyWithPerf(
            solver='ECOS')
        unflattened_throughputs = {
            0: {'v100': 2.0, 'p100': 1.0, 'k80': 0.5},
            1: {'v100': 3.0, 'p100': 2.0, 'k80': 1.0},
    ...
    def test_two_level_single_pass_hierarchical(self):
