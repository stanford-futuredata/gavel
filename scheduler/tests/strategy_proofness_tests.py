...
from policies import max_min_fairness_strategy_proof
...
if __name__ == '__main__':
    ...
    times = []
    for i in range(5):
        times.append(test_strategy_proofness())
